...
const ALCHEMY_API_KEY = process.env.NEXT_PUBLIC_REACT_APP_ALCHEMY_API_KEY || "";

// Grab an Alchemy Gas Policy ID from https://dashboard.alchemy.com/gas-manager
const ALCHEMY_GAS_POLICY_ID = process.env.NEXT_PUBLIC_REACT_APP_ALCHEMY_GAS_POLICY_ID || "";
