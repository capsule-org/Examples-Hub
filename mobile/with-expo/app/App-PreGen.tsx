...
export const PregenAuth = () => {
  ...
  const handleSignUp = async () => {
    try {
      ...
      const pregenExists = await capsuleClient.hasPregenWallet(email, PregenIdentifierType.EMAIL);
      ...
      if (userShare) {
        const encryptedUserShare = CryptoJS.AES.encrypt(userShare, password).toString();
