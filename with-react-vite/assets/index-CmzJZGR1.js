const e=[{title:"Export Session on Client",subtitle:"Export the current session from the client-side Capsule instance",code:`
  // Client-side code
  ...
  });`},{title:"Import Session on Server",subtitle:"Import the exported session on your server to enable server-side signing",code:`
  // Server-side code
  ...
  });`},{title:"Security Considerations",subtitle:"Important security notes for session management",code:`
  ...
  // Use appropriate environment variables for different deployments`}];export{e as default};
