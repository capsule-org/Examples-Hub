const e=[{title:"Check Session Status",subtitle:"Verify if the user is currently logged in",code:`
...
console.log("Session expires at:", session?.expiresAt);`},{title:"Refresh Session",subtitle:"Extend the current session before it expires",code:`
...
};`},{title:"Logout",subtitle:"End the current session",code:`
// Simple logout
const logout = async () => {
...
const cleanupAndLogout = async () => {
  ...
  router.push('/login');
};`},{title:"Session Management Best Practices",subtitle:"Recommendations for handling sessions effectively",code:`
